...
import ReMax from "../../public/assets/Beth_and_Matthew_ReMax_Logo.png";
import Furman from "../../public/assets/Furman_Excavation.jpg";
  ...
  return (
      <div className="min-h-screen">
        ...
        <section className="relative h-screen">
          ...
          />
          <div
              className="absolute inset-0 flex flex-col justify-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center md:text-left">
        ...
        <div className="relative">
            ...
            <div className=" grid md:grid-cols-6 gap-12 items-center">
              <div className="bg-white py-6 md:py-8 lg:py-24 px-6 sm:px-24 xl:px-48 md:col-span-4">
                ...
                <p className="text-gray-700 mb-6">
                  We are a Christ-centered educational institution dedicated to nurturing the academic and spiritual
                  growth of students from Kindergarten through 6th grade. Our mission is to provide a supportive and
                  inspiring environment where young minds can flourish, rooted in Christian values and biblical truth.
                  At Foundation Christian Academy, we believe in the vital importance of parent involvement and
                  partnership, working together to equip students with the knowledge, character, and skills needed to
          ...
          <section
              className="bg-[#8B0000] text-white py-16 px-4 sm:px-6 lg:px-8 md:py-52 relative md:absolute md:top-72 -z-10 w-full">
            <div className="max-w-7xl mx-auto">
              <h2 className="text-3xl font-bold mb-8">What You Need to Know</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="mb-4">
                    Get ready to run for a great cause at the FOUNDATION 5K! Lace up your sneakers and join us on March
                    29th, 2025 for a fun, family-friendly race to support Foundation Christian Academy. The race kicks
                    off at 10:30 AM at the McLean County Pony League Baseball Fields (3707 Ireland Grove Road,
                    Bloomington, IL). We’ll race west on Ireland Grove Road and then head east on Abraham Road,
                    finishing at Victory Church, the exciting new home of Foundation Christian Academy!
                  </p>
                  <p>
                ...
                <div>
                  <div className="mt-4">
                    <p>Check-in begins at 9:30 AM at the Pony League Fields. The registration fee is just $30 and
                      includes a free Foundation 5K T-shirt to commemorate your participation. All proceeds from the
                      event will directly benefit scholarships for students and support our dedicated staff, helping us
                      continue to provide a vibrant and enriching learning environment for all our students.
        ...
        <section className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
          ...
          <div
              className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white ring-1 shadow-xl shadow-indigo-600/10 ring-indigo-50 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center"/>
          <div className="mx-auto max-w-2xl lg:max-w-4xl">
            <h2 className="text-3xl font-bold text-[#8B0000] mb-6 text-center">Thanks to our Sponsors!</h2>
            <figure className="mt-10 flex flex-col md:flex-row md:justify-between">
              <div>
                <img
                    alt=""
                    src={Furman.src}
                ...
                <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                  <div className="font-semibold text-gray-900">Furman Excavation</div>
                  <svg width={3} height={3} viewBox="0 0 2 2" aria-hidden="true" className="fill-gray-900">
                    <circle r={1} cx={1} cy={1}/>
                  </svg>
                  <div className="text-gray-600">Platinum Sponsor</div>
                </div>
              </div>
              <div>
                <img
                ...
                />
                <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                  <div className="font-semibold text-gray-900">ReMax</div>
                  <svg width={3} height={3} viewBox="0 0 2 2" aria-hidden="true" className="fill-gray-900">
                    <circle r={1} cx={1} cy={1}/>
                  </svg>
                  <div className="text-gray-600">Platinum Sponsor</div>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
            ...
            <div className="grid grid-cols-2 gap-8 md:order-2">
              ...
              <div>
                ...
                <p><span className="font-bold">$30</span> Race Fee + <span className="font-bold">$2.89</span> Sign up
                  fee</p>
              </div>
              <div>
